...
def writeToReadmeEnhanced():
  ...
  for i in range(len(filenames)):
    html_string += f"<td>{filenames[i]}</td>"
  html_string += "</tr>"
  html_string += f"""
    <tr>
    <td>New Arrival</td>
  ...
  for i in range(len(filenames)):
    ...
    <td>
      <table>
        ...
        <tr>
          <td>Median</td>
          <td>{median_queue_delta_sideways[i]}</td>
        </tr>
        <tr>
          <td>Average</td>
  ...
  for i in range(len(filenames)):
    ...
    <td>
      <table>
        ...
        <tr>
          <td>Median</td>
          <td>{median_pickup_queue_delta[i]}</td>
        </tr>
        <tr>
          <td>Average</td>
  ...
  with open("READMEnhanced.md", "w") as f:
    f.write(html_string)
